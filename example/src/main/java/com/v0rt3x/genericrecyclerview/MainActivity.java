...
public class MainActivity extends AppCompatActivity {
    ...
    private RecyclerViewAdapter<RecyclerViewDataModel> getRecyclerViewAdapter() {
        RecyclerViewAdapter<RecyclerViewDataModel> adapter = new RecyclerViewAdapter<>(mData, Constants.LayoutType.LINEAR);
